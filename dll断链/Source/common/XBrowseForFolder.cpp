...
CStringW XBrowseForFolderA( HWND hWnd, CStringW lpszInitialFolder, int nFolder, LPCTSTR lpszCaption, BOOL bEditBox /*= TRUE*/ )
{
	CStringW sz;
	XBrowseForFolder(hWnd,lpszInitialFolder,nFolder,lpszCaption,sz.GetBuffer(MAX_PATH),MAX_PATH,bEditBox);
	sz.ReleaseBuffer();
	return sz;
}
