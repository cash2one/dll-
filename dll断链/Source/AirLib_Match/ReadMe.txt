========================================================================
    动态链接库：AirLib_Match 项目概述
========================================================================

应用程序向导已为您创建了此 AirLib_Match DLL。

本文件概要介绍组成 AirLib_Match 应用程序的每个文件的内容。


AirLib_Match.vcxproj
    这是使用应用程序向导生成的 VC++ 项目的主项目文件，
    其中包含生成该文件的 Visual C++ 
    的版本信息，以及有关使用应用程序向导选择的平台、配置和项目功能的信息。

AirLib_Match.vcxproj.filters
...
StdAfx.h，StdAfx.cpp
    这些文件用于生成名为 AirLib_Match.pch 的预编译头 (PCH) 文件和
