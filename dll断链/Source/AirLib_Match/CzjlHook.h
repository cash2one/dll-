...
public:
	...
	static bool FindHookCallBack_JMP(CStringA szTargetDll,CStringA szHookDll);
	
	static unsigned int FindDllTarget(CStringA szDll,CStringA szTarget,char* pTag,unsigned int LenTag,unsigned int SearchLen=0);
